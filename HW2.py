# У нас есть список номерных знаков.
#
...
#
#
# Данные вводить через input()
#
# Вывод данных единовременно. (Нас спрашивают информацию мы вводим номер, и получаем сразу все сведения)
#
#
#
# Результат домашнего задания предоставление текста программы (или файла с кодом)
